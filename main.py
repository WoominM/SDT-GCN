...
#         help='decay rate for learning rate')
    ...
    parser.add_argument('--cosine_epoch', type=int, default=0)
...
#             raise ValueError()
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            self.data_shape = [1, 3, self.arg.train_feeder_args['window_size'], 25, 2]
...
#             weights_path = glob.glob(self.savepath + '/epoch_' + '109'+'*')[0]
